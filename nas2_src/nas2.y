...
instruction:
	...
	| PUSH REG '[' INT ']' 		{ in[pc] = PUSHRI; op[pc] = $2; opx[pc++] = $4; }
	| PUSH REG '[' REG ']'		{ in[pc] = PUSHRR; op[pc] = $2; opx[pc++] = $4; }
	| POP REG					{ in[pc] = POPR; op[pc++] = $2; }
	| POP REG '[' INT ']'		{ in[pc] = POPRI; op[pc] = $2; opx[pc++] = $4; }
	| POP REG '[' REG ']'		{ in[pc] = POPRR; op[pc] = $2; opx[pc++] = $4; }
	| CALL LABEL ',' INT 		{ in[pc] = CALL; op[pc] = $2; opx[pc++] = $4; }
	| RET						{ in[pc++] = RET; }
	| END						{ in[pc++] = END; }
	| LT						{ in[pc++] = LT; }
	| GT						{ in[pc++] = GT; }
